...
public  class ComparationsMysql implements Runnable{
    ...
    public void insertAtom(List<Empresas> emp,String origin){
        ...
        Comparations.matTempos.put("Time_Insert_Atom_"+origin+"_MySql", dif);
    }
    ...
    public void editingAtom(List<Empresas> emp,String origin){
        ...
        Comparations.matTempos.put("Time_Edit_Atom_"+origin+"_MySql", dif);
    }
    ...
    public void deletAtom(List<Empresas> emp,String origin){
        ...
        Comparations.matTempos.put("Time_Delete_Atom_"+origin+"_MySql", dif);
    }
    ...
    public void insertManual(List<Empresas> emp){
        ...
        String sql = "INSERT INTO empresas( cnpj, tipo, fantasia, situacao, datasituacao, motivosituacao, nomecidadeexterior, pais," +
                ...
                "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
        try{
            PreparedStatement stmt = conMysql.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
    ...
    public void editManual(List<Empresas> emp){
        ...
        Comparations.matTempos.put("Time_Edit_Manual_MySql", dif);
    }
    ...
    public void deletManual(List<Empresas> emp){
        ...
        Comparations.matTempos.put("Time_Delete_Manual_MySql", dif);
    }
